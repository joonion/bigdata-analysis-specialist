...
as.matrix(dist(nutrient, method="euclidian"))[1:5,1:5]
as.matrix(dist(nutrient, method="manhattan"))[1:5,1:5]
as.matrix(dist(nutrient, method="binary"))[1:5,1:5]
...
data(flower)
str(flower)
as.matrix(daisy(flower, metric = "gower"))[1:5, 1:5]
...
plot(clustering.average, hang=-1, cex=0.9, col="darkgreen", xlab="Food", 
